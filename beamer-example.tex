...
\begin{enumerate}
\item Django, Grok and Web.py 
\item Angular.js was recommended by the main project
\item Bootstrap was used as the front-end framework.
...
There were quite a few challenges in the project. I was from a pure theoritical background, 
\begin{enumerate}
\item Python
\item JavaScript
